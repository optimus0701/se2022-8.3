...
## Bước 2: vào thư mục ReactNative/MyShopee chạy npm install để cài thư viện(cài nodejs trước)
...
## Bước 6: chạy file start.bat trong thư mục ReactNative/MyShopee để chạy app sau đó vào expo go trên điện thoại để xem kết quả
